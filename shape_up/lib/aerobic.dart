...
class Aerobic extends StatefulWidget {
  const Aerobic({Key? key}) : super(key: key);
...
class _AerobicState extends State<Aerobic> {
  List aerobic = [];
  _initData() async {
    await DefaultAssetBundle.of(context).loadString("json/aerobic.json").then((value){
      setState(() {
        aerobic = json.decode(value);
      });
    });
  }
  @override
